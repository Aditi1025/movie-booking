...
const NewMovie = ({ }) => {
  ...
  const {data, loading, error} = useFetch("/theaters");
        ...
        <div className="bottom">
          ...
          <div className="right">
            <form>
              ...
              <div className="selectTheaters">
                  <label>Theaters</label>
                  <select id="theaters" multiple onChange={handleSelect}>
                  {loading ? "loading" : data && data.map(theater => (
